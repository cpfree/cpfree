...
<Configuration>
    ...
    <Properties>
        <!--申明全局别名，下面可以直接使用-->
        <Property name="APP_Name">ity-institution</Property>
        <Property name="log.dir">D:/temp/logs/ity-institution</Property>
    </Properties>
    ...
    <Appenders>
        ...
        <Console name="console_out_appender" target="SYSTEM_OUT">
            ...
            <!-- 输出日志的格式 -->
            <PatternLayout pattern="[%p] [ity-institution] %d{yyyy-MM-dd HH:mm:ss} (%F:%L) %m%n" />
        </Console>
    ...
    <Loggers>
        ...
        <Logger name="ats.ity" level="DEBUG"/>
